...
if (!empty($_GET)) {
    if (isset($_GET['CarImages'])) {
        ...
        $CarMarqueSelected = $_GET['CarMarqueSelected'];
...
if (!isset($_SESSION['OrderData']['days'])) {
    // if (isset($_GET['CarId'])) { 
 echo $_SESSION['OrderData']['days'];
            ...
            <div class="vehicleDiv">
                ...
                <div class="vehicleDiv_descrip">
                    ...
                    <div class="vehicleImage">
                        ...
                        <h4><?php echo $CarMarqueSelected ?></h4>
                    </div>
                ...
                <div class="Rate">
                    ...
                    <div>
                        <p> <B>Basic rate for <?php echo $_SESSION['OrderData']['days'];?> days </B></p>
                        <p>Included </p>
                    </div>
